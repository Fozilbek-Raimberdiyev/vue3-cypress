  ...
  <div class="relative bg-yellow-50 overflow-hidden max-h-screen">
    ...
    <aside class="fixed inset-y-0 left-0 bg-white shadow-md max-h-screen w-60">
      <div class="flex flex-col justify-between h-full">
          ...
          <div class="p-4">
            <ul class="space-y-1">
              <li>
                <RouterLink
                  to="/"
                  class="flex items-center rounded-xl font-bold text-sm text-yellow-900 py-3 px-4"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="1em"
        ...
        <RouterLink to="/auth/login" class="p-4 flex items-center">
          <!-- <button
              type="button"
    ...
    <main class="ml-60 pt-16 min-h-screen overflow-auto px-6 py-8">
